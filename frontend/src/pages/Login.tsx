  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink-900 px-4">
      <div className="w-full max-w-sm">
        ...
        >
          <p className="font-display text-2xl font-semibold text-white">SAMS</p>
          <p className="mt-1 text-sm text-ink-200">Student Attendance Management System</p>
        </motion.div>
        <motion.form
        ...
        >
          <h1 className="font-display text-xl font-semibold text-ink-800">Sign in</h1>
          <p className="mt-1 text-sm text-ink-400">Use your institutional account.</p>
          ...
          <Link to="/forgot-password" className="mt-4 block text-center text-sm text-ink-400 transition hover:text-ink-700">
