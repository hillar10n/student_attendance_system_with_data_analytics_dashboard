	...
	return (
		<Layout>
			...
			<p className="mt-1 text-sm text-ink-400">
				Low-attendance alerts for your courses.
			</p>
				...
				<Card>
					{loading ? (
						...
						<p className="text-sm text-ink-400">
							No notifications — your attendance is above the threshold on all
							courses.
						</p>
					) : (
						<ul className="divide-y divide-ink-100">
							{notifications.map((n) => (
								<li key={n.id} className="flex items-start gap-3 py-3">
									<span
										className="mt-0.5 h-2 w-2 flex-shrink-0 rounded-full bg-bad-500"
										aria-hidden
									/>
									<div>
